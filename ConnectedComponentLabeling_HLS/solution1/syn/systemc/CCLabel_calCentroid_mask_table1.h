...
#ifndef __CCLabel_calCentroid_mask_table1_H__
#define __CCLabel_calCentroid_mask_table1_H__
...
struct CCLabel_calCentroid_mask_table1_ram : public sc_core::sc_module {
...
sc_lv<DataWidth> ram[AddressRange];
   ...
   SC_CTOR(CCLabel_calCentroid_mask_table1_ram) {
...
SC_MODULE(CCLabel_calCentroid_mask_table1) {
...
CCLabel_calCentroid_mask_table1_ram* meminst;


SC_CTOR(CCLabel_calCentroid_mask_table1) {
meminst = new CCLabel_calCentroid_mask_table1_ram("CCLabel_calCentroid_mask_table1_ram");
