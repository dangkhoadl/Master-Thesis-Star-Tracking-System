...
entity CCLabel_calCentroid_mask_table1_rom is 
    generic(
             dwidth     : integer := 52; 
             awidth     : integer := 6; 
             mem_size    : integer := 64
...
architecture rtl of CCLabel_calCentroid_mask_table1_rom is 
...
entity CCLabel_calCentroid_mask_table1 is
    generic (
...
architecture arch of CCLabel_calCentroid_mask_table1 is
    component CCLabel_calCentroid_mask_table1_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    CCLabel_calCentroid_mask_table1_rom_U :  component CCLabel_calCentroid_mask_table1_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
