...
%struct.starStruct.29 = type { i1, i32, i32, i32 }
%struct.centroid.30 = type { i32, float, float }
...
; [#uses=3]
define internal fastcc i32 @find(i32 %i, i32* %set) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2705), !dbg !2706 ; [debug line = 27:24] [debug variable = i]
  call void @llvm.dbg.value(metadata !{i32* %set}, i64 0, metadata !2707), !dbg !2708 ; [debug line = 27:35] [debug variable = set]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %set, i32 30) nounwind, !dbg !2709 ; [debug line = 27:45]
  call void @llvm.dbg.value(metadata !{i32 %i}, i64 0, metadata !2711), !dbg !2712 ; [debug line = 28:19] [debug variable = temp]
  br label %1, !dbg !2713                         ; [debug line = 29:2]

; <label>:1                                       ; preds = %2, %0
  %temp = phi i32 [ %i, %0 ], [ %temp.1, %2 ]     ; [#uses=3 type=i32]
  %tmp = zext i32 %temp to i64, !dbg !2713        ; [#uses=1 type=i64] [debug line = 29:2]
  %set.addr = getelementptr inbounds i32* %set, i64 %tmp, !dbg !2713 ; [#uses=1 type=i32*] [debug line = 29:2]
  %temp.1 = load i32* %set.addr, align 4, !dbg !2713 ; [#uses=4 type=i32] [debug line = 29:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp.1) nounwind
  %tmp.1 = icmp eq i32 %temp, %temp.1, !dbg !2713 ; [#uses=1 type=i1] [debug line = 29:2]
  br i1 %tmp.1, label %3, label %2, !dbg !2713    ; [debug line = 29:2]

; <label>:2                                       ; preds = %1
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp.1) nounwind
  call void @llvm.dbg.value(metadata !{i32 %temp.1}, i64 0, metadata !2711), !dbg !2714 ; [debug line = 30:3] [debug variable = temp]
  br label %1, !dbg !2716                         ; [debug line = 31:2]

; <label>:3                                       ; preds = %1
  %temp.0.lcssa = phi i32 [ %temp, %1 ]           ; [#uses=1 type=i32]
  ret i32 %temp.0.lcssa, !dbg !2717               ; [debug line = 32:2]
}
...
; [#uses=1]
define internal fastcc void @preProcess([8 x i32]* %Image, [8 x i32]* %lbImage) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{[8 x i32]* %Image}, i64 0, metadata !2718), !dbg !2719 ; [debug line = 35:26] [debug variable = Image]
  call void @llvm.dbg.value(metadata !{[8 x i32]* %lbImage}, i64 0, metadata !2720), !dbg !2721 ; [debug line = 35:48] [debug variable = lbImage]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %lbImage, i32 8) nounwind, !dbg !2722 ; [debug line = 35:64]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %Image, i32 8) nounwind, !dbg !2724 ; [debug line = 35:98]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2725 ; [debug line = 37:1]
  br label %1, !dbg !2726                         ; [debug line = 38:7]

; <label>:1                                       ; preds = %6, %0
  %i = phi i32 [ 0, %0 ], [ %i.1, %6 ]            ; [#uses=3 type=i32]
  %exitcond1 = icmp eq i32 %i, 8, !dbg !2726      ; [#uses=1 type=i1] [debug line = 38:7]
  br i1 %exitcond1, label %7, label %.preheader.preheader, !dbg !2726 ; [debug line = 38:7]

.preheader.preheader:                             ; preds = %1
  %tmp = zext i32 %i to i64, !dbg !2728           ; [#uses=3 type=i64] [debug line = 40:4]
  br label %.preheader, !dbg !2732                ; [debug line = 39:8]

.preheader:                                       ; preds = %5, %.preheader.preheader
  %j = phi i32 [ %j.1, %5 ], [ 0, %.preheader.preheader ] ; [#uses=3 type=i32]
  %exitcond = icmp eq i32 %j, 8, !dbg !2732       ; [#uses=1 type=i1] [debug line = 39:8]
  br i1 %exitcond, label %6, label %2, !dbg !2732 ; [debug line = 39:8]

; <label>:2                                       ; preds = %.preheader
  %tmp.3 = zext i32 %j to i64, !dbg !2728         ; [#uses=3 type=i64] [debug line = 40:4]
  %Image.addr = getelementptr inbounds [8 x i32]* %Image, i64 %tmp, i64 %tmp.3, !dbg !2728 ; [#uses=1 type=i32*] [debug line = 40:4]
  %Image.load = load i32* %Image.addr, align 4, !dbg !2728 ; [#uses=2 type=i32] [debug line = 40:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %Image.load) nounwind
  %tmp.4 = icmp ult i32 %Image.load, 70, !dbg !2728 ; [#uses=1 type=i1] [debug line = 40:4]
  br i1 %tmp.4, label %3, label %4, !dbg !2728    ; [debug line = 40:4]

; <label>:3                                       ; preds = %2
  %lbImage.addr = getelementptr inbounds [8 x i32]* %lbImage, i64 %tmp, i64 %tmp.3, !dbg !2733 ; [#uses=1 type=i32*] [debug line = 41:5]
  store i32 0, i32* %lbImage.addr, align 4, !dbg !2733 ; [debug line = 41:5]
  br label %5, !dbg !2733                         ; [debug line = 41:5]

; <label>:4                                       ; preds = %2
  %lbImage.addr.1 = getelementptr inbounds [8 x i32]* %lbImage, i64 %tmp, i64 %tmp.3, !dbg !2734 ; [#uses=1 type=i32*] [debug line = 43:5]
  store i32 1, i32* %lbImage.addr.1, align 4, !dbg !2734 ; [debug line = 43:5]
  br label %5

; <label>:5                                       ; preds = %4, %3
  %j.1 = add i32 %j, 1, !dbg !2735                ; [#uses=1 type=i32] [debug line = 39:22]
  call void @llvm.dbg.value(metadata !{i32 %j.1}, i64 0, metadata !2736), !dbg !2735 ; [debug line = 39:22] [debug variable = j]
  br label %.preheader, !dbg !2735                ; [debug line = 39:22]

; <label>:6                                       ; preds = %.preheader
  %i.1 = add i32 %i, 1, !dbg !2737                ; [#uses=1 type=i32] [debug line = 38:21]
  call void @llvm.dbg.value(metadata !{i32 %i.1}, i64 0, metadata !2738), !dbg !2737 ; [debug line = 38:21] [debug variable = i]
  br label %1, !dbg !2737                         ; [debug line = 38:21]

; <label>:7                                       ; preds = %1
  ret void, !dbg !2739                            ; [debug line = 47:1]
}
...
; [#uses=1]
define internal fastcc i32 @firstPass([8 x i32]* %Image, [8 x i32]* %lbImage, %struct.starStruct.29* %starData, i32* %set) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{[8 x i32]* %Image}, i64 0, metadata !2740), !dbg !2741 ; [debug line = 49:30] [debug variable = Image]
  call void @llvm.dbg.value(metadata !{[8 x i32]* %lbImage}, i64 0, metadata !2742), !dbg !2743 ; [debug line = 50:15] [debug variable = lbImage]
  call void @llvm.dbg.value(metadata !{%struct.starStruct.29* %starData}, i64 0, metadata !2744), !dbg !2745 ; [debug line = 51:17] [debug variable = starData]
  call void @llvm.dbg.value(metadata !{i32* %set}, i64 0, metadata !2746), !dbg !2747 ; [debug line = 52:15] [debug variable = set]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %set, i32 30) nounwind, !dbg !2748 ; [debug line = 52:25]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %lbImage, i32 8) nounwind, !dbg !2750 ; [debug line = 52:56]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.starStruct.29* %starData, i32 30) nounwind, !dbg !2751 ; [debug line = 52:90]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %Image, i32 8) nounwind, !dbg !2752 ; [debug line = 52:126]
  br label %1, !dbg !2753                         ; [debug line = 61:6]

; <label>:1                                       ; preds = %16, %0
  %label = phi i32 [ 0, %0 ], [ %label.1.lcssa, %16 ] ; [#uses=1 type=i32]
  %i = phi i32 [ 0, %0 ], [ %i.2, %16 ]           ; [#uses=7 type=i32]
  %setCount = phi i32 [ 1, %0 ], [ %setCount.1.lcssa, %16 ] ; [#uses=2 type=i32]
  %exitcond1 = icmp eq i32 %i, 8, !dbg !2753      ; [#uses=1 type=i1] [debug line = 61:6]
  br i1 %exitcond1, label %17, label %.preheader.preheader, !dbg !2753 ; [debug line = 61:6]

.preheader.preheader:                             ; preds = %1
  %tmp = zext i32 %i to i64, !dbg !2755           ; [#uses=4 type=i64] [debug line = 64:2]
  %tmp.6 = icmp eq i32 %i, 0, !dbg !2759          ; [#uses=1 type=i1] [debug line = 68:4]
  %tmp.7 = add i32 %i, -1, !dbg !2759             ; [#uses=1 type=i32] [debug line = 68:4]
  %tmp.8 = zext i32 %tmp.7 to i64, !dbg !2759     ; [#uses=1 type=i64] [debug line = 68:4]
  br label %.preheader, !dbg !2760                ; [debug line = 62:7]

.preheader:                                       ; preds = %._crit_edge, %.preheader.preheader
  %label.1 = phi i32 [ %label.3, %._crit_edge ], [ %label, %.preheader.preheader ] ; [#uses=4 type=i32]
  %j = phi i32 [ %j.2, %._crit_edge ], [ 0, %.preheader.preheader ] ; [#uses=7 type=i32]
  %setCount.1 = phi i32 [ %setCount.3, %._crit_edge ], [ %setCount, %.preheader.preheader ] ; [#uses=5 type=i32]
  %exitcond = icmp eq i32 %j, 8, !dbg !2760       ; [#uses=1 type=i1] [debug line = 62:7]
  br i1 %exitcond, label %16, label %2, !dbg !2760 ; [debug line = 62:7]

; <label>:2                                       ; preds = %.preheader
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0)) nounwind, !dbg !2761 ; [#uses=1 type=i32] [debug line = 62:27]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2762 ; [debug line = 63:1]
  %tmp.10 = zext i32 %j to i64, !dbg !2755        ; [#uses=4 type=i64] [debug line = 64:2]
  %lbImage.addr = getelementptr inbounds [8 x i32]* %lbImage, i64 %tmp, i64 %tmp.10, !dbg !2755 ; [#uses=3 type=i32*] [debug line = 64:2]
  %lbImage.load = load i32* %lbImage.addr, align 4, !dbg !2755 ; [#uses=2 type=i32] [debug line = 64:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lbImage.load) nounwind
  %tmp.11 = icmp eq i32 %lbImage.load, 0, !dbg !2755 ; [#uses=1 type=i1] [debug line = 64:2]
  br i1 %tmp.11, label %._crit_edge, label %3, !dbg !2755 ; [debug line = 64:2]

; <label>:3                                       ; preds = %2
  br i1 %tmp.6, label %._crit_edge2, label %4, !dbg !2759 ; [debug line = 68:4]

; <label>:4                                       ; preds = %3
  %lbImage.addr.2 = getelementptr inbounds [8 x i32]* %lbImage, i64 %tmp.8, i64 %tmp.10, !dbg !2759 ; [#uses=1 type=i32*] [debug line = 68:4]
  %lbImage.load.1 = load i32* %lbImage.addr.2, align 4, !dbg !2759 ; [#uses=4 type=i32] [debug line = 68:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lbImage.load.1) nounwind
  %tmp.12 = icmp eq i32 %lbImage.load.1, 0, !dbg !2759 ; [#uses=1 type=i1] [debug line = 68:4]
  br i1 %tmp.12, label %._crit_edge2, label %5, !dbg !2759 ; [debug line = 68:4]

; <label>:5                                       ; preds = %4
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lbImage.load.1) nounwind
  br label %6, !dbg !2759                         ; [debug line = 68:4]

._crit_edge2:                                     ; preds = %4, %3
  br label %6, !dbg !2759                         ; [debug line = 68:4]

; <label>:6                                       ; preds = %._crit_edge2, %5
  %prevAbove = phi i32 [ %lbImage.load.1, %5 ], [ 999, %._crit_edge2 ], !dbg !2759 ; [#uses=5 type=i32] [debug line = 68:4]
  call void @llvm.dbg.value(metadata !{i32 %prevAbove}, i64 0, metadata !2763), !dbg !2759 ; [debug line = 68:4] [debug variable = prevAbove]
  %tmp.14 = icmp eq i32 %j, 0, !dbg !2764         ; [#uses=1 type=i1] [debug line = 69:4]
  br i1 %tmp.14, label %._crit_edge4, label %7, !dbg !2764 ; [debug line = 69:4]

; <label>:7                                       ; preds = %6
  %tmp.15 = add i32 %j, -1, !dbg !2764            ; [#uses=1 type=i32] [debug line = 69:4]
  %tmp.16 = zext i32 %tmp.15 to i64, !dbg !2764   ; [#uses=1 type=i64] [debug line = 69:4]
  %lbImage.addr.3 = getelementptr inbounds [8 x i32]* %lbImage, i64 %tmp, i64 %tmp.16, !dbg !2764 ; [#uses=1 type=i32*] [debug line = 69:4]
  %lbImage.load.2 = load i32* %lbImage.addr.3, align 4, !dbg !2764 ; [#uses=4 type=i32] [debug line = 69:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lbImage.load.2) nounwind
  %tmp.17 = icmp eq i32 %lbImage.load.2, 0, !dbg !2764 ; [#uses=1 type=i1] [debug line = 69:4]
  br i1 %tmp.17, label %._crit_edge4, label %8, !dbg !2764 ; [debug line = 69:4]

; <label>:8                                       ; preds = %7
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %lbImage.load.2) nounwind
  br label %9, !dbg !2764                         ; [debug line = 69:4]

._crit_edge4:                                     ; preds = %7, %6
  br label %9, !dbg !2764                         ; [debug line = 69:4]

; <label>:9                                       ; preds = %._crit_edge4, %8
  %prevLeft = phi i32 [ %lbImage.load.2, %8 ], [ 999, %._crit_edge4 ], !dbg !2764 ; [#uses=5 type=i32] [debug line = 69:4]
  call void @llvm.dbg.value(metadata !{i32 %prevLeft}, i64 0, metadata !2765), !dbg !2764 ; [debug line = 69:4] [debug variable = prevLeft]
  %tmp.19 = icmp eq i32 %prevAbove, 999, !dbg !2766 ; [#uses=1 type=i1] [debug line = 71:4]
  %tmp.20 = icmp eq i32 %prevLeft, 999, !dbg !2766 ; [#uses=1 type=i1] [debug line = 71:4]
  %or.cond = and i1 %tmp.19, %tmp.20, !dbg !2766  ; [#uses=1 type=i1] [debug line = 71:4]
  br i1 %or.cond, label %10, label %11, !dbg !2766 ; [debug line = 71:4]

; <label>:10                                      ; preds = %9
  %label.4 = add i32 %label.1, 1, !dbg !2767      ; [#uses=3 type=i32] [debug line = 72:5]
  call void @llvm.dbg.value(metadata !{i32 %label.4}, i64 0, metadata !2769), !dbg !2767 ; [debug line = 72:5] [debug variable = label]
  store i32 %label.4, i32* %lbImage.addr, align 4, !dbg !2767 ; [debug line = 72:5]
  %tmp.22 = zext i32 %setCount.1 to i64, !dbg !2770 ; [#uses=5 type=i64] [debug line = 73:5]
  %set.addr = getelementptr inbounds i32* %set, i64 %tmp.22, !dbg !2770 ; [#uses=1 type=i32*] [debug line = 73:5]
  store i32 %label.4, i32* %set.addr, align 4, !dbg !2770 ; [debug line = 73:5]
  %Image.addr = getelementptr inbounds [8 x i32]* %Image, i64 %tmp, i64 %tmp.10, !dbg !2771 ; [#uses=1 type=i32*] [debug line = 77:5]
  %temp.totalIntensity = load i32* %Image.addr, align 4, !dbg !2771 ; [#uses=6 type=i32] [debug line = 77:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp.totalIntensity) nounwind
  call void @llvm.dbg.value(metadata !{i32 %temp.totalIntensity}, i64 0, metadata !2772), !dbg !2771 ; [debug line = 77:5] [debug variable = temp.totalIntensity]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp.totalIntensity) nounwind
  %temp.x = mul i32 %temp.totalIntensity, %i, !dbg !2776 ; [#uses=1 type=i32] [debug line = 78:5]
  call void @llvm.dbg.value(metadata !{i32 %temp.x}, i64 0, metadata !2777), !dbg !2776 ; [debug line = 78:5] [debug variable = temp.x]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %temp.totalIntensity) nounwind
  %temp.y = mul i32 %temp.totalIntensity, %j, !dbg !2780 ; [#uses=1 type=i32] [debug line = 79:5]
  call void @llvm.dbg.value(metadata !{i32 %temp.y}, i64 0, metadata !2781), !dbg !2780 ; [debug line = 79:5] [debug variable = temp.y]
  %starData.addr = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.22, i32 0, !dbg !2784 ; [#uses=1 type=i1*] [debug line = 80:5]
  store i1 true, i1* %starData.addr, align 1, !dbg !2784 ; [debug line = 80:5]
  %starData.addr.1 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.22, i32 1, !dbg !2784 ; [#uses=1 type=i32*] [debug line = 80:5]
  store i32 %temp.totalIntensity, i32* %starData.addr.1, align 4, !dbg !2784 ; [debug line = 80:5]
  %starData.addr.2 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.22, i32 2, !dbg !2784 ; [#uses=1 type=i32*] [debug line = 80:5]
  store i32 %temp.x, i32* %starData.addr.2, align 4, !dbg !2784 ; [debug line = 80:5]
  %starData.addr.3 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.22, i32 3, !dbg !2784 ; [#uses=1 type=i32*] [debug line = 80:5]
  store i32 %temp.y, i32* %starData.addr.3, align 4, !dbg !2784 ; [debug line = 80:5]
  %setCount.4 = add i32 %setCount.1, 1, !dbg !2785 ; [#uses=1 type=i32] [debug line = 82:5]
  call void @llvm.dbg.value(metadata !{i32 %setCount.4}, i64 0, metadata !2786), !dbg !2785 ; [debug line = 82:5] [debug variable = setCount]
  br label %15, !dbg !2787                        ; [debug line = 83:4]

; <label>:11                                      ; preds = %9
  %tmp.24 = icmp ult i32 %prevAbove, %prevLeft, !dbg !2788 ; [#uses=1 type=i1] [debug line = 86:5]
  %min = select i1 %tmp.24, i32 %prevAbove, i32 %prevLeft, !dbg !2788 ; [#uses=5 type=i32] [debug line = 86:5]
  call void @llvm.dbg.value(metadata !{i32 %min}, i64 0, metadata !2790), !dbg !2788 ; [debug line = 86:5] [debug variable = min]
  %tmp.26 = icmp ugt i32 %prevAbove, %prevLeft, !dbg !2791 ; [#uses=1 type=i1] [debug line = 87:5]
  %max = select i1 %tmp.26, i32 %prevAbove, i32 %prevLeft, !dbg !2791 ; [#uses=2 type=i32] [debug line = 87:5]
  call void @llvm.dbg.value(metadata !{i32 %max}, i64 0, metadata !2792), !dbg !2791 ; [debug line = 87:5] [debug variable = max]
  %tmp.28 = icmp eq i32 %max, 999, !dbg !2793     ; [#uses=1 type=i1] [debug line = 88:5]
  br i1 %tmp.28, label %13, label %12, !dbg !2793 ; [debug line = 88:5]

; <label>:12                                      ; preds = %11
  %tmp.31 = call fastcc i32 @find(i32 %min, i32* %set), !dbg !2794 ; [#uses=1 type=i32] [debug line = 89:17]
  %tmp.32 = zext i32 %max to i64, !dbg !2794      ; [#uses=1 type=i64] [debug line = 89:17]
  %set.addr.2 = getelementptr inbounds i32* %set, i64 %tmp.32, !dbg !2794 ; [#uses=1 type=i32*] [debug line = 89:17]
  store i32 %tmp.31, i32* %set.addr.2, align 4, !dbg !2794 ; [debug line = 89:17]
  br label %14, !dbg !2796                        ; [debug line = 90:5]

; <label>:13                                      ; preds = %11
  %tmp.29 = call fastcc i32 @find(i32 %min, i32* %set), !dbg !2797 ; [#uses=1 type=i32] [debug line = 92:17]
  %tmp.30 = zext i32 %min to i64, !dbg !2797      ; [#uses=1 type=i64] [debug line = 92:17]
  %set.addr.1 = getelementptr inbounds i32* %set, i64 %tmp.30, !dbg !2797 ; [#uses=1 type=i32*] [debug line = 92:17]
  store i32 %tmp.29, i32* %set.addr.1, align 4, !dbg !2797 ; [debug line = 92:17]
  br label %14

; <label>:14                                      ; preds = %13, %12
  store i32 %min, i32* %lbImage.addr, align 4, !dbg !2799 ; [debug line = 94:5]
  %Image.addr.1 = getelementptr inbounds [8 x i32]* %Image, i64 %tmp, i64 %tmp.10, !dbg !2800 ; [#uses=3 type=i32*] [debug line = 97:5]
  %Image.load = load i32* %Image.addr.1, align 4, !dbg !2800 ; [#uses=2 type=i32] [debug line = 97:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %Image.load) nounwind
  %tmp.33 = zext i32 %min to i64, !dbg !2800      ; [#uses=3 type=i64] [debug line = 97:5]
  %starData.addr.4 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.33, i32 1, !dbg !2800 ; [#uses=2 type=i32*] [debug line = 97:5]
  %starData.load = load i32* %starData.addr.4, align 4, !dbg !2800 ; [#uses=2 type=i32] [debug line = 97:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load) nounwind
  %tmp.34 = add i32 %starData.load, %Image.load, !dbg !2800 ; [#uses=1 type=i32] [debug line = 97:5]
  store i32 %tmp.34, i32* %starData.addr.4, align 4, !dbg !2800 ; [debug line = 97:5]
  %Image.load.1 = load i32* %Image.addr.1, align 4, !dbg !2801 ; [#uses=2 type=i32] [debug line = 98:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %Image.load.1) nounwind
  %tmp.35 = mul i32 %Image.load.1, %i, !dbg !2801 ; [#uses=1 type=i32] [debug line = 98:5]
  %starData.addr.5 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.33, i32 2, !dbg !2801 ; [#uses=2 type=i32*] [debug line = 98:5]
  %starData.load.1 = load i32* %starData.addr.5, align 4, !dbg !2801 ; [#uses=2 type=i32] [debug line = 98:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.1) nounwind
  %tmp.36 = add i32 %starData.load.1, %tmp.35, !dbg !2801 ; [#uses=1 type=i32] [debug line = 98:5]
  store i32 %tmp.36, i32* %starData.addr.5, align 4, !dbg !2801 ; [debug line = 98:5]
  %Image.load.2 = load i32* %Image.addr.1, align 4, !dbg !2802 ; [#uses=2 type=i32] [debug line = 99:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %Image.load.2) nounwind
  %tmp.37 = mul i32 %Image.load.2, %j, !dbg !2802 ; [#uses=1 type=i32] [debug line = 99:5]
  %starData.addr.6 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.33, i32 3, !dbg !2802 ; [#uses=2 type=i32*] [debug line = 99:5]
  %starData.load.2 = load i32* %starData.addr.6, align 4, !dbg !2802 ; [#uses=2 type=i32] [debug line = 99:5]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.2) nounwind
  %tmp.38 = add i32 %starData.load.2, %tmp.37, !dbg !2802 ; [#uses=1 type=i32] [debug line = 99:5]
  store i32 %tmp.38, i32* %starData.addr.6, align 4, !dbg !2802 ; [debug line = 99:5]
  br label %15

; <label>:15                                      ; preds = %14, %10
  %label.2 = phi i32 [ %label.4, %10 ], [ %label.1, %14 ] ; [#uses=1 type=i32]
  %setCount.2 = phi i32 [ %setCount.4, %10 ], [ %setCount.1, %14 ] ; [#uses=1 type=i32]
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str1, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2803 ; [#uses=0 type=i32] [debug line = 101:3]
  br label %._crit_edge, !dbg !2804               ; [debug line = 101:34]

._crit_edge:                                      ; preds = %15, %2
  %label.3 = phi i32 [ %label.2, %15 ], [ %label.1, %2 ] ; [#uses=1 type=i32]
  %setCount.3 = phi i32 [ %setCount.2, %15 ], [ %setCount.1, %2 ] ; [#uses=1 type=i32]
  %j.2 = add i32 %j, 1, !dbg !2805                ; [#uses=1 type=i32] [debug line = 62:21]
  call void @llvm.dbg.value(metadata !{i32 %j.2}, i64 0, metadata !2806), !dbg !2805 ; [debug line = 62:21] [debug variable = j]
  br label %.preheader, !dbg !2805                ; [debug line = 62:21]
...
; <label>:16                                      ; preds = %.preheader
  ...
  %i.2 = add i32 %i, 1, !dbg !2807                ; [#uses=1 type=i32] [debug line = 61:20]
  call void @llvm.dbg.value(metadata !{i32 %i.2}, i64 0, metadata !2808), !dbg !2807 ; [debug line = 61:20] [debug variable = i]
  br label %1, !dbg !2807                         ; [debug line = 61:20]

; <label>:17                                      ; preds = %1
  %setCount.0.lcssa = phi i32 [ %setCount, %1 ]   ; [#uses=1 type=i32]
  ret i32 %setCount.0.lcssa, !dbg !2809           ; [debug line = 103:2]
}

; [#uses=1]
define internal fastcc i32 @calCentroid(i32* %set, %struct.starStruct.29* %starData, %struct.centroid.30* %centroidData, i32 %setCount) nounwind uwtable {
  call void @llvm.dbg.value(metadata !{i32* %set}, i64 0, metadata !2810), !dbg !2811 ; [debug line = 106:31] [debug variable = set]
  call void @llvm.dbg.value(metadata !{%struct.starStruct.29* %starData}, i64 0, metadata !2812), !dbg !2813 ; [debug line = 106:51] [debug variable = starData]
  call void @llvm.dbg.value(metadata !{%struct.centroid.30* %centroidData}, i64 0, metadata !2814), !dbg !2815 ; [debug line = 106:74] [debug variable = centroidData]
  call void @llvm.dbg.value(metadata !{i32 %setCount}, i64 0, metadata !2816), !dbg !2817 ; [debug line = 106:101] [debug variable = setCount]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %set, i32 30) nounwind, !dbg !2818 ; [debug line = 106:112]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.starStruct.29* %starData, i32 30) nounwind, !dbg !2820 ; [debug line = 106:143]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.centroid.30* %centroidData, i32 30) nounwind, !dbg !2821 ; [debug line = 106:179]
  br label %1, !dbg !2822                         ; [debug line = 111:6]

; <label>:1                                       ; preds = %._crit_edge, %0
  %i = phi i32 [ 1, %0 ], [ %i.3, %._crit_edge ]  ; [#uses=5 type=i32]
  %tmp = icmp ult i32 %i, %setCount, !dbg !2822   ; [#uses=1 type=i1] [debug line = 111:6]
  br i1 %tmp, label %2, label %.preheader.preheader, !dbg !2822 ; [debug line = 111:6]

.preheader.preheader:                             ; preds = %1
  br label %.preheader, !dbg !2824                ; [debug line = 123:6]

; <label>:2                                       ; preds = %1
  %rbegin = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0)) nounwind, !dbg !2826 ; [#uses=1 type=i32] [debug line = 111:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2828 ; [debug line = 112:1]
  %tmp.40 = zext i32 %i to i64, !dbg !2829        ; [#uses=5 type=i64] [debug line = 113:2]
  %set.addr = getelementptr inbounds i32* %set, i64 %tmp.40, !dbg !2829 ; [#uses=1 type=i32*] [debug line = 113:2]
  %set.load = load i32* %set.addr, align 4, !dbg !2829 ; [#uses=2 type=i32] [debug line = 113:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %set.load) nounwind
  %tmp.41 = icmp eq i32 %set.load, %i, !dbg !2829 ; [#uses=1 type=i1] [debug line = 113:2]
  br i1 %tmp.41, label %._crit_edge, label %3, !dbg !2829 ; [debug line = 113:2]

; <label>:3                                       ; preds = %2
  %root = call fastcc i32 @find(i32 %i, i32* %set), !dbg !2830 ; [#uses=1 type=i32] [debug line = 114:11]
  call void @llvm.dbg.value(metadata !{i32 %root}, i64 0, metadata !2832), !dbg !2830 ; [debug line = 114:11] [debug variable = root]
  %starData.addr = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.40, i32 1, !dbg !2833 ; [#uses=1 type=i32*] [debug line = 115:4]
  %starData.load = load i32* %starData.addr, align 4, !dbg !2833 ; [#uses=2 type=i32] [debug line = 115:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load) nounwind
  %tmp.43 = zext i32 %root to i64, !dbg !2833     ; [#uses=3 type=i64] [debug line = 115:4]
  %starData.addr.7 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.43, i32 1, !dbg !2833 ; [#uses=2 type=i32*] [debug line = 115:4]
  %starData.load.3 = load i32* %starData.addr.7, align 4, !dbg !2833 ; [#uses=2 type=i32] [debug line = 115:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.3) nounwind
  %tmp.44 = add i32 %starData.load.3, %starData.load, !dbg !2833 ; [#uses=1 type=i32] [debug line = 115:4]
  store i32 %tmp.44, i32* %starData.addr.7, align 4, !dbg !2833 ; [debug line = 115:4]
  %starData.addr.8 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.40, i32 2, !dbg !2834 ; [#uses=1 type=i32*] [debug line = 116:4]
  %starData.load.4 = load i32* %starData.addr.8, align 4, !dbg !2834 ; [#uses=2 type=i32] [debug line = 116:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.4) nounwind
  %starData.addr.9 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.43, i32 2, !dbg !2834 ; [#uses=2 type=i32*] [debug line = 116:4]
  %starData.load.5 = load i32* %starData.addr.9, align 4, !dbg !2834 ; [#uses=2 type=i32] [debug line = 116:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.5) nounwind
  %tmp.45 = add i32 %starData.load.5, %starData.load.4, !dbg !2834 ; [#uses=1 type=i32] [debug line = 116:4]
  store i32 %tmp.45, i32* %starData.addr.9, align 4, !dbg !2834 ; [debug line = 116:4]
  %starData.addr.10 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.40, i32 3, !dbg !2835 ; [#uses=1 type=i32*] [debug line = 117:4]
  %starData.load.6 = load i32* %starData.addr.10, align 4, !dbg !2835 ; [#uses=2 type=i32] [debug line = 117:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.6) nounwind
  %starData.addr.11 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.43, i32 3, !dbg !2835 ; [#uses=2 type=i32*] [debug line = 117:4]
  %starData.load.7 = load i32* %starData.addr.11, align 4, !dbg !2835 ; [#uses=2 type=i32] [debug line = 117:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.7) nounwind
  %tmp.46 = add i32 %starData.load.7, %starData.load.6, !dbg !2835 ; [#uses=1 type=i32] [debug line = 117:4]
  store i32 %tmp.46, i32* %starData.addr.11, align 4, !dbg !2835 ; [debug line = 117:4]
  %starData.addr.12 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.40, i32 0, !dbg !2836 ; [#uses=1 type=i1*] [debug line = 118:4]
  store i1 false, i1* %starData.addr.12, align 1, !dbg !2836 ; [debug line = 118:4]
  br label %._crit_edge, !dbg !2837               ; [debug line = 119:3]

._crit_edge:                                      ; preds = %3, %2
  %rend = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str2, i64 0, i64 0), i32 %rbegin) nounwind, !dbg !2838 ; [#uses=0 type=i32] [debug line = 120:2]
  %i.3 = add i32 %i, 1, !dbg !2839                ; [#uses=1 type=i32] [debug line = 111:27]
  call void @llvm.dbg.value(metadata !{i32 %i.3}, i64 0, metadata !2840), !dbg !2839 ; [debug line = 111:27] [debug variable = i]
  br label %1, !dbg !2839                         ; [debug line = 111:27]

.preheader:                                       ; preds = %._crit_edge1, %.preheader.preheader
  %temp.root = phi i32 [ %i.4, %._crit_edge1 ], [ 1, %.preheader.preheader ] ; [#uses=4 type=i32]
  %centroidDataCount = phi i32 [ %centroidDataCount.1, %._crit_edge1 ], [ 0, %.preheader.preheader ] ; [#uses=4 type=i32]
  %tmp.47 = icmp ult i32 %temp.root, %setCount, !dbg !2824 ; [#uses=1 type=i1] [debug line = 123:6]
  br i1 %tmp.47, label %4, label %6, !dbg !2824   ; [debug line = 123:6]

; <label>:4                                       ; preds = %.preheader
  %rbegin2 = call i32 (...)* @_ssdm_op_SpecRegionBegin(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0)) nounwind, !dbg !2841 ; [#uses=1 type=i32] [debug line = 123:33]
  call void (...)* @_ssdm_op_SpecPipeline(i32 1, i32 1, i32 1, i32 0, i8* getelementptr inbounds ([1 x i8]* @.str, i64 0, i64 0)) nounwind, !dbg !2843 ; [debug line = 124:1]
  %tmp.49 = zext i32 %temp.root to i64, !dbg !2844 ; [#uses=4 type=i64] [debug line = 125:2]
  %starData.addr.13 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.49, i32 0, !dbg !2844 ; [#uses=1 type=i1*] [debug line = 125:2]
  %starData.load.8 = load i1* %starData.addr.13, align 1, !dbg !2844 ; [#uses=2 type=i1] [debug line = 125:2]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i1 %starData.load.8) nounwind
  br i1 %starData.load.8, label %5, label %._crit_edge1, !dbg !2844 ; [debug line = 125:2]

; <label>:5                                       ; preds = %4
  call void @llvm.dbg.value(metadata !{i32 %temp.root}, i64 0, metadata !2845), !dbg !2849 ; [debug line = 126:4] [debug variable = temp.root]
  %starData.addr.14 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.49, i32 2, !dbg !2851 ; [#uses=1 type=i32*] [debug line = 127:4]
  %starData.load.9 = load i32* %starData.addr.14, align 4, !dbg !2851 ; [#uses=2 type=i32] [debug line = 127:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.9) nounwind
  %tmp.50 = uitofp i32 %starData.load.9 to float, !dbg !2851 ; [#uses=1 type=float] [debug line = 127:4]
  %starData.addr.15 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.49, i32 1, !dbg !2851 ; [#uses=1 type=i32*] [debug line = 127:4]
  %starData.load.10 = load i32* %starData.addr.15, align 4, !dbg !2851 ; [#uses=3 type=i32] [debug line = 127:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.10) nounwind
  %tmp.51 = uitofp i32 %starData.load.10 to float, !dbg !2851 ; [#uses=2 type=float] [debug line = 127:4]
  %temp.x = fdiv float %tmp.50, %tmp.51, !dbg !2851 ; [#uses=1 type=float] [debug line = 127:4]
  call void @llvm.dbg.value(metadata !{float %temp.x}, i64 0, metadata !2852), !dbg !2851 ; [debug line = 127:4] [debug variable = temp.x]
  %starData.addr.16 = getelementptr inbounds %struct.starStruct.29* %starData, i64 %tmp.49, i32 3, !dbg !2855 ; [#uses=1 type=i32*] [debug line = 128:4]
  %starData.load.11 = load i32* %starData.addr.16, align 4, !dbg !2855 ; [#uses=2 type=i32] [debug line = 128:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.11) nounwind
  %tmp.52 = uitofp i32 %starData.load.11 to float, !dbg !2855 ; [#uses=1 type=float] [debug line = 128:4]
  call void (...)* @_ssdm_SpecKeepArrayLoad(i32 %starData.load.10) nounwind
  %temp.y = fdiv float %tmp.52, %tmp.51, !dbg !2855 ; [#uses=1 type=float] [debug line = 128:4]
  call void @llvm.dbg.value(metadata !{float %temp.y}, i64 0, metadata !2856), !dbg !2855 ; [debug line = 128:4] [debug variable = temp.y]
  %tmp.53 = zext i32 %centroidDataCount to i64, !dbg !2859 ; [#uses=3 type=i64] [debug line = 130:4]
  %centroidData.addr = getelementptr inbounds %struct.centroid.30* %centroidData, i64 %tmp.53, i32 0, !dbg !2859 ; [#uses=1 type=i32*] [debug line = 130:4]
  store i32 %temp.root, i32* %centroidData.addr, align 4, !dbg !2859 ; [debug line = 130:4]
  %centroidData.addr.1 = getelementptr inbounds %struct.centroid.30* %centroidData, i64 %tmp.53, i32 1, !dbg !2859 ; [#uses=1 type=float*] [debug line = 130:4]
  store float %temp.x, float* %centroidData.addr.1, align 4, !dbg !2859 ; [debug line = 130:4]
  %centroidData.addr.2 = getelementptr inbounds %struct.centroid.30* %centroidData, i64 %tmp.53, i32 2, !dbg !2859 ; [#uses=1 type=float*] [debug line = 130:4]
  store float %temp.y, float* %centroidData.addr.2, align 4, !dbg !2859 ; [debug line = 130:4]
  %centroidDataCount.2 = add i32 %centroidDataCount, 1, !dbg !2860 ; [#uses=1 type=i32] [debug line = 131:4]
  call void @llvm.dbg.value(metadata !{i32 %centroidDataCount.2}, i64 0, metadata !2861), !dbg !2860 ; [debug line = 131:4] [debug variable = centroidDataCount]
  br label %._crit_edge1, !dbg !2862              ; [debug line = 132:3]

._crit_edge1:                                     ; preds = %5, %4
  %centroidDataCount.1 = phi i32 [ %centroidDataCount.2, %5 ], [ %centroidDataCount, %4 ] ; [#uses=1 type=i32]
  %rend3 = call i32 (...)* @_ssdm_op_SpecRegionEnd(i8* getelementptr inbounds ([12 x i8]* @.str3, i64 0, i64 0), i32 %rbegin2) nounwind, !dbg !2863 ; [#uses=0 type=i32] [debug line = 133:2]
  %i.4 = add i32 %temp.root, 1, !dbg !2864        ; [#uses=1 type=i32] [debug line = 123:27]
  call void @llvm.dbg.value(metadata !{i32 %i.4}, i64 0, metadata !2840), !dbg !2864 ; [debug line = 123:27] [debug variable = i]
  br label %.preheader, !dbg !2864                ; [debug line = 123:27]

; <label>:6                                       ; preds = %.preheader
  %centroidDataCount.0.lcssa = phi i32 [ %centroidDataCount, %.preheader ] ; [#uses=1 type=i32]
  ret i32 %centroidDataCount.0.lcssa, !dbg !2865  ; [debug line = 134:2]
}

; [#uses=0]
define i32 @CCLabel([8 x i32]* %Image, [8 x i32]* %lbImage, %struct.starStruct.29* %starData, i32* %set, %struct.centroid.30* %centroidData) nounwind uwtable {
  call void (...)* @_ssdm_op_SpecBitsMap(i32 0) nounwind, !map !2866
  call void (...)* @_ssdm_op_SpecTopModule([8 x i8]* @str) nounwind
  call void @llvm.dbg.value(metadata !{[8 x i32]* %Image}, i64 0, metadata !2872), !dbg !2873 ; [debug line = 137:27] [debug variable = Image]
  call void @llvm.dbg.value(metadata !{[8 x i32]* %lbImage}, i64 0, metadata !2874), !dbg !2875 ; [debug line = 137:49] [debug variable = lbImage]
  call void @llvm.dbg.value(metadata !{%struct.starStruct.29* %starData}, i64 0, metadata !2876), !dbg !2877 ; [debug line = 137:75] [debug variable = starData]
  call void @llvm.dbg.value(metadata !{i32* %set}, i64 0, metadata !2878), !dbg !2879 ; [debug line = 137:98] [debug variable = set]
  call void @llvm.dbg.value(metadata !{%struct.centroid.30* %centroidData}, i64 0, metadata !2880), !dbg !2881 ; [debug line = 137:116] [debug variable = centroidData]
  call void (...)* @_ssdm_SpecArrayDimSize(i32* %set, i32 30) nounwind, !dbg !2882 ; [debug line = 137:135]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %lbImage, i32 8) nounwind, !dbg !2884 ; [debug line = 137:166]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.starStruct.29* %starData, i32 30) nounwind, !dbg !2885 ; [debug line = 137:200]
  call void (...)* @_ssdm_SpecArrayDimSize([8 x i32]* %Image, i32 8) nounwind, !dbg !2886 ; [debug line = 137:236]
  call void (...)* @_ssdm_SpecArrayDimSize(%struct.centroid.30* %centroidData, i32 30) nounwind, !dbg !2887 ; [debug line = 137:0]
  call fastcc void @preProcess([8 x i32]* %Image, [8 x i32]* %lbImage), !dbg !2888 ; [debug line = 138:2]
  %setCount = call fastcc i32 @firstPass([8 x i32]* %Image, [8 x i32]* %lbImage, %struct.starStruct.29* %starData, i32* %set), !dbg !2889 ; [#uses=1 type=i32] [debug line = 139:22]
  call void @llvm.dbg.value(metadata !{i32 %setCount}, i64 0, metadata !2890), !dbg !2889 ; [debug line = 139:22] [debug variable = setCount]
  %centroidDataCount = call fastcc i32 @calCentroid(i32* %set, %struct.starStruct.29* %starData, %struct.centroid.30* %centroidData, i32 %setCount), !dbg !2891 ; [#uses=1 type=i32] [debug line = 140:31]
  call void @llvm.dbg.value(metadata !{i32 %centroidDataCount}, i64 0, metadata !2892), !dbg !2891 ; [debug line = 140:31] [debug variable = centroidDataCount]
  ret i32 %centroidDataCount, !dbg !2893          ; [debug line = 142:2]
}
...
!869 = metadata !{i32 786478, i32 0, metadata !870, metadata !"find", metadata !"find", metadata !"_Z4findjPj", metadata !870, i32 27, metadata !871, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32, i32*)* @find, null, null, metadata !87, i32 27} ; [ DW_TAG_subprogram ]
...
!875 = metadata !{i32 786478, i32 0, metadata !870, metadata !"preProcess", metadata !"preProcess", metadata !"_Z10preProcessPA8_jS0_", metadata !870, i32 35, metadata !876, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, void ([8 x i32]*, [8 x i32]*)* @preProcess, null, null, metadata !87, i32 35} ; [ DW_TAG_subprogram ]
...
!880 = metadata !{i32 786478, i32 0, metadata !870, metadata !"firstPass", metadata !"firstPass", metadata !"_Z9firstPassPA8_jS0_P10starStructPj", metadata !870, i32 49, metadata !881, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ([8 x i32]*, [8 x i32]*, %struct.starStruct.29*, i32*)* @firstPass, null, null, metadata !87, i32 52} ; [ DW_TAG_subprogram ]
...
!900 = metadata !{i32 786478, i32 0, metadata !870, metadata !"calCentroid", metadata !"calCentroid", metadata !"_Z11calCentroidPjP10starStructP8centroidj", metadata !870, i32 106, metadata !901, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 (i32*, %struct.starStruct.29*, %struct.centroid.30*, i32)* @calCentroid, null, null, metadata !87, i32 106} ; [ DW_TAG_subprogram ]
...
!920 = metadata !{i32 786478, i32 0, metadata !870, metadata !"CCLabel", metadata !"CCLabel", metadata !"_Z7CCLabelPA8_jS0_P10starStructPjP8centroid", metadata !870, i32 137, metadata !921, i1 false, i1 true, i32 0, i32 0, null, i32 256, i1 false, i32 ([8 x i32]*, [8 x i32]*, %struct.starStruct.29*, i32*, %struct.centroid.30*)* @CCLabel, null, null, metadata !87, i32 137} ; [ DW_TAG_subprogram ]
...
!2705 = metadata !{i32 786689, metadata !869, metadata !"i", metadata !870, i32 16777243, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2706 = metadata !{i32 27, i32 24, metadata !869, null}
!2707 = metadata !{i32 786689, metadata !869, metadata !"set", metadata !870, i32 33554459, metadata !874, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2708 = metadata !{i32 27, i32 35, metadata !869, null}
!2709 = metadata !{i32 27, i32 45, metadata !2710, null}
!2710 = metadata !{i32 786443, metadata !869, i32 27, i32 44, metadata !870, i32 0} ; [ DW_TAG_lexical_block ]
!2711 = metadata !{i32 786688, metadata !2710, metadata !"temp", metadata !870, i32 28, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2712 = metadata !{i32 28, i32 19, metadata !2710, null}
!2713 = metadata !{i32 29, i32 2, metadata !2710, null}
!2714 = metadata !{i32 30, i32 3, metadata !2715, null}
!2715 = metadata !{i32 786443, metadata !2710, i32 29, i32 28, metadata !870, i32 1} ; [ DW_TAG_lexical_block ]
!2716 = metadata !{i32 31, i32 2, metadata !2715, null}
!2717 = metadata !{i32 32, i32 2, metadata !2710, null}
!2718 = metadata !{i32 786689, metadata !875, metadata !"Image", metadata !870, i32 16777251, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2719 = metadata !{i32 35, i32 26, metadata !875, null}
!2720 = metadata !{i32 786689, metadata !875, metadata !"lbImage", metadata !870, i32 33554467, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2721 = metadata !{i32 35, i32 48, metadata !875, null}
!2722 = metadata !{i32 35, i32 64, metadata !2723, null}
!2723 = metadata !{i32 786443, metadata !875, i32 35, i32 63, metadata !870, i32 2} ; [ DW_TAG_lexical_block ]
!2724 = metadata !{i32 35, i32 98, metadata !2723, null}
!2725 = metadata !{i32 37, i32 1, metadata !2723, null}
!2726 = metadata !{i32 38, i32 7, metadata !2727, null}
!2727 = metadata !{i32 786443, metadata !2723, i32 38, i32 2, metadata !870, i32 3} ; [ DW_TAG_lexical_block ]
!2728 = metadata !{i32 40, i32 4, metadata !2729, null}
!2729 = metadata !{i32 786443, metadata !2730, i32 39, i32 27, metadata !870, i32 6} ; [ DW_TAG_lexical_block ]
!2730 = metadata !{i32 786443, metadata !2731, i32 39, i32 3, metadata !870, i32 5} ; [ DW_TAG_lexical_block ]
!2731 = metadata !{i32 786443, metadata !2727, i32 38, i32 26, metadata !870, i32 4} ; [ DW_TAG_lexical_block ]
!2732 = metadata !{i32 39, i32 8, metadata !2730, null}
!2733 = metadata !{i32 41, i32 5, metadata !2729, null}
!2734 = metadata !{i32 43, i32 5, metadata !2729, null}
!2735 = metadata !{i32 39, i32 22, metadata !2730, null}
!2736 = metadata !{i32 786688, metadata !2723, metadata !"j", metadata !870, i32 36, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2737 = metadata !{i32 38, i32 21, metadata !2727, null}
!2738 = metadata !{i32 786688, metadata !2723, metadata !"i", metadata !870, i32 36, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2739 = metadata !{i32 47, i32 1, metadata !2723, null}
!2740 = metadata !{i32 786689, metadata !880, metadata !"Image", metadata !870, i32 16777265, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2741 = metadata !{i32 49, i32 30, metadata !880, null}
!2742 = metadata !{i32 786689, metadata !880, metadata !"lbImage", metadata !870, i32 33554482, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2743 = metadata !{i32 50, i32 15, metadata !880, null}
!2744 = metadata !{i32 786689, metadata !880, metadata !"starData", metadata !870, i32 50331699, metadata !883, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2745 = metadata !{i32 51, i32 17, metadata !880, null}
!2746 = metadata !{i32 786689, metadata !880, metadata !"set", metadata !870, i32 67108916, metadata !874, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2747 = metadata !{i32 52, i32 15, metadata !880, null}
!2748 = metadata !{i32 52, i32 25, metadata !2749, null}
!2749 = metadata !{i32 786443, metadata !880, i32 52, i32 24, metadata !870, i32 7} ; [ DW_TAG_lexical_block ]
!2750 = metadata !{i32 52, i32 56, metadata !2749, null}
!2751 = metadata !{i32 52, i32 90, metadata !2749, null}
!2752 = metadata !{i32 52, i32 126, metadata !2749, null}
!2753 = metadata !{i32 61, i32 6, metadata !2754, null}
!2754 = metadata !{i32 786443, metadata !2749, i32 61, i32 2, metadata !870, i32 8} ; [ DW_TAG_lexical_block ]
!2755 = metadata !{i32 64, i32 2, metadata !2756, null}
!2756 = metadata !{i32 786443, metadata !2757, i32 62, i32 26, metadata !870, i32 11} ; [ DW_TAG_lexical_block ]
!2757 = metadata !{i32 786443, metadata !2758, i32 62, i32 3, metadata !870, i32 10} ; [ DW_TAG_lexical_block ]
!2758 = metadata !{i32 786443, metadata !2754, i32 61, i32 25, metadata !870, i32 9} ; [ DW_TAG_lexical_block ]
!2759 = metadata !{i32 68, i32 4, metadata !2756, null}
!2760 = metadata !{i32 62, i32 7, metadata !2757, null}
!2761 = metadata !{i32 62, i32 27, metadata !2756, null}
!2762 = metadata !{i32 63, i32 1, metadata !2756, null}
!2763 = metadata !{i32 786688, metadata !2749, metadata !"prevAbove", metadata !870, i32 55, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2764 = metadata !{i32 69, i32 4, metadata !2756, null}
!2765 = metadata !{i32 786688, metadata !2749, metadata !"prevLeft", metadata !870, i32 56, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2766 = metadata !{i32 71, i32 4, metadata !2756, null}
!2767 = metadata !{i32 72, i32 5, metadata !2768, null}
!2768 = metadata !{i32 786443, metadata !2756, i32 71, i32 45, metadata !870, i32 13} ; [ DW_TAG_lexical_block ]
!2769 = metadata !{i32 786688, metadata !2749, metadata !"label", metadata !870, i32 54, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2770 = metadata !{i32 73, i32 5, metadata !2768, null}
!2771 = metadata !{i32 77, i32 5, metadata !2768, null}
!2772 = metadata !{i32 790529, metadata !2773, metadata !"temp.totalIntensity", null, i32 58, metadata !2774, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2773 = metadata !{i32 786688, metadata !2749, metadata !"temp", metadata !870, i32 58, metadata !884, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2774 = metadata !{i32 786438, null, metadata !"starStruct", metadata !870, i32 14, i64 32, i64 32, i32 0, i32 0, null, metadata !2775, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2775 = metadata !{metadata !887}
!2776 = metadata !{i32 78, i32 5, metadata !2768, null}
!2777 = metadata !{i32 790529, metadata !2773, metadata !"temp.x", null, i32 58, metadata !2778, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!2779 = metadata !{metadata !888}
!2780 = metadata !{i32 79, i32 5, metadata !2768, null}
!2781 = metadata !{i32 790529, metadata !2773, metadata !"temp.y", null, i32 58, metadata !2782, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
...
!2783 = metadata !{metadata !889}
!2784 = metadata !{i32 80, i32 5, metadata !2768, null}
!2785 = metadata !{i32 82, i32 5, metadata !2768, null}
!2786 = metadata !{i32 786688, metadata !2749, metadata !"setCount", metadata !870, i32 57, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2787 = metadata !{i32 83, i32 4, metadata !2768, null}
!2788 = metadata !{i32 86, i32 5, metadata !2789, null}
!2789 = metadata !{i32 786443, metadata !2756, i32 84, i32 9, metadata !870, i32 14} ; [ DW_TAG_lexical_block ]
!2790 = metadata !{i32 786688, metadata !2749, metadata !"min", metadata !870, i32 59, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2791 = metadata !{i32 87, i32 5, metadata !2789, null}
!2792 = metadata !{i32 786688, metadata !2749, metadata !"max", metadata !870, i32 60, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2793 = metadata !{i32 88, i32 5, metadata !2789, null}
!2794 = metadata !{i32 89, i32 17, metadata !2795, null}
!2795 = metadata !{i32 786443, metadata !2789, i32 88, i32 21, metadata !870, i32 15} ; [ DW_TAG_lexical_block ]
!2796 = metadata !{i32 90, i32 5, metadata !2795, null}
!2797 = metadata !{i32 92, i32 17, metadata !2798, null}
!2798 = metadata !{i32 786443, metadata !2789, i32 91, i32 10, metadata !870, i32 16} ; [ DW_TAG_lexical_block ]
!2799 = metadata !{i32 94, i32 5, metadata !2789, null}
!2800 = metadata !{i32 97, i32 5, metadata !2789, null}
!2801 = metadata !{i32 98, i32 5, metadata !2789, null}
!2802 = metadata !{i32 99, i32 5, metadata !2789, null}
!2803 = metadata !{i32 101, i32 3, metadata !2756, null}
!2804 = metadata !{i32 101, i32 34, metadata !2756, null}
!2805 = metadata !{i32 62, i32 21, metadata !2757, null}
!2806 = metadata !{i32 786688, metadata !2749, metadata !"j", metadata !870, i32 53, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2807 = metadata !{i32 61, i32 20, metadata !2754, null}
!2808 = metadata !{i32 786688, metadata !2749, metadata !"i", metadata !870, i32 53, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2809 = metadata !{i32 103, i32 2, metadata !2749, null}
!2810 = metadata !{i32 786689, metadata !900, metadata !"set", metadata !870, i32 16777322, metadata !874, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2811 = metadata !{i32 106, i32 31, metadata !900, null}
!2812 = metadata !{i32 786689, metadata !900, metadata !"starData", metadata !870, i32 33554538, metadata !883, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2813 = metadata !{i32 106, i32 51, metadata !900, null}
!2814 = metadata !{i32 786689, metadata !900, metadata !"centroidData", metadata !870, i32 50331754, metadata !903, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2815 = metadata !{i32 106, i32 74, metadata !900, null}
!2816 = metadata !{i32 786689, metadata !900, metadata !"setCount", metadata !870, i32 67108970, metadata !873, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2817 = metadata !{i32 106, i32 101, metadata !900, null}
!2818 = metadata !{i32 106, i32 112, metadata !2819, null}
!2819 = metadata !{i32 786443, metadata !900, i32 106, i32 111, metadata !870, i32 17} ; [ DW_TAG_lexical_block ]
!2820 = metadata !{i32 106, i32 143, metadata !2819, null}
!2821 = metadata !{i32 106, i32 179, metadata !2819, null}
!2822 = metadata !{i32 111, i32 6, metadata !2823, null}
!2823 = metadata !{i32 786443, metadata !2819, i32 111, i32 2, metadata !870, i32 18} ; [ DW_TAG_lexical_block ]
!2824 = metadata !{i32 123, i32 6, metadata !2825, null}
!2825 = metadata !{i32 786443, metadata !2819, i32 123, i32 2, metadata !870, i32 21} ; [ DW_TAG_lexical_block ]
!2826 = metadata !{i32 111, i32 33, metadata !2827, null}
!2827 = metadata !{i32 786443, metadata !2823, i32 111, i32 32, metadata !870, i32 19} ; [ DW_TAG_lexical_block ]
!2828 = metadata !{i32 112, i32 1, metadata !2827, null}
!2829 = metadata !{i32 113, i32 2, metadata !2827, null}
!2830 = metadata !{i32 114, i32 11, metadata !2831, null}
!2831 = metadata !{i32 786443, metadata !2827, i32 113, i32 18, metadata !870, i32 20} ; [ DW_TAG_lexical_block ]
!2832 = metadata !{i32 786688, metadata !2819, metadata !"root", metadata !870, i32 108, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2833 = metadata !{i32 115, i32 4, metadata !2831, null}
!2834 = metadata !{i32 116, i32 4, metadata !2831, null}
!2835 = metadata !{i32 117, i32 4, metadata !2831, null}
!2836 = metadata !{i32 118, i32 4, metadata !2831, null}
!2837 = metadata !{i32 119, i32 3, metadata !2831, null}
!2838 = metadata !{i32 120, i32 2, metadata !2827, null}
!2839 = metadata !{i32 111, i32 27, metadata !2823, null}
!2840 = metadata !{i32 786688, metadata !2819, metadata !"i", metadata !870, i32 107, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2841 = metadata !{i32 123, i32 33, metadata !2842, null}
!2842 = metadata !{i32 786443, metadata !2825, i32 123, i32 32, metadata !870, i32 22} ; [ DW_TAG_lexical_block ]
!2843 = metadata !{i32 124, i32 1, metadata !2842, null}
!2844 = metadata !{i32 125, i32 2, metadata !2842, null}
!2845 = metadata !{i32 790529, metadata !2846, metadata !"temp.root", null, i32 110, metadata !2847, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2846 = metadata !{i32 786688, metadata !2819, metadata !"temp", metadata !870, i32 110, metadata !904, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2847 = metadata !{i32 786438, null, metadata !"centroid", metadata !870, i32 21, i64 32, i64 32, i32 0, i32 0, null, metadata !2848, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2848 = metadata !{metadata !906}
!2849 = metadata !{i32 126, i32 4, metadata !2850, null}
!2850 = metadata !{i32 786443, metadata !2842, i32 125, i32 33, metadata !870, i32 23} ; [ DW_TAG_lexical_block ]
!2851 = metadata !{i32 127, i32 4, metadata !2850, null}
!2852 = metadata !{i32 790529, metadata !2846, metadata !"temp.x", null, i32 110, metadata !2853, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2853 = metadata !{i32 786438, null, metadata !"centroid", metadata !870, i32 21, i64 32, i64 32, i32 0, i32 0, null, metadata !2854, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2854 = metadata !{metadata !907}
!2855 = metadata !{i32 128, i32 4, metadata !2850, null}
!2856 = metadata !{i32 790529, metadata !2846, metadata !"temp.y", null, i32 110, metadata !2857, i32 0, i32 0} ; [ DW_TAG_auto_variable_field ]
!2857 = metadata !{i32 786438, null, metadata !"centroid", metadata !870, i32 21, i64 32, i64 32, i32 0, i32 0, null, metadata !2858, i32 0, null, null} ; [ DW_TAG_class_field_type ]
!2858 = metadata !{metadata !909}
!2859 = metadata !{i32 130, i32 4, metadata !2850, null}
!2860 = metadata !{i32 131, i32 4, metadata !2850, null}
!2861 = metadata !{i32 786688, metadata !2819, metadata !"centroidDataCount", metadata !870, i32 109, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2862 = metadata !{i32 132, i32 3, metadata !2850, null}
!2863 = metadata !{i32 133, i32 2, metadata !2842, null}
!2864 = metadata !{i32 123, i32 27, metadata !2825, null}
!2865 = metadata !{i32 134, i32 2, metadata !2819, null}
!2866 = metadata !{metadata !2867}
!2867 = metadata !{i32 0, i32 31, metadata !2868}
!2868 = metadata !{metadata !2869}
!2869 = metadata !{metadata !"return", metadata !2870, metadata !"unsigned int", i32 0, i32 31}
!2870 = metadata !{metadata !2871}
!2871 = metadata !{i32 0, i32 1, i32 0}
!2872 = metadata !{i32 786689, metadata !920, metadata !"Image", metadata !870, i32 16777353, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2873 = metadata !{i32 137, i32 27, metadata !920, null}
!2874 = metadata !{i32 786689, metadata !920, metadata !"lbImage", metadata !870, i32 33554569, metadata !878, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2875 = metadata !{i32 137, i32 49, metadata !920, null}
!2876 = metadata !{i32 786689, metadata !920, metadata !"starData", metadata !870, i32 50331785, metadata !883, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2877 = metadata !{i32 137, i32 75, metadata !920, null}
!2878 = metadata !{i32 786689, metadata !920, metadata !"set", metadata !870, i32 67109001, metadata !874, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2879 = metadata !{i32 137, i32 98, metadata !920, null}
!2880 = metadata !{i32 786689, metadata !920, metadata !"centroidData", metadata !870, i32 83886217, metadata !903, i32 0, i32 0} ; [ DW_TAG_arg_variable ]
!2881 = metadata !{i32 137, i32 116, metadata !920, null}
!2882 = metadata !{i32 137, i32 135, metadata !2883, null}
!2883 = metadata !{i32 786443, metadata !920, i32 137, i32 134, metadata !870, i32 24} ; [ DW_TAG_lexical_block ]
!2884 = metadata !{i32 137, i32 166, metadata !2883, null}
!2885 = metadata !{i32 137, i32 200, metadata !2883, null}
!2886 = metadata !{i32 137, i32 236, metadata !2883, null}
!2887 = metadata !{i32 137, i32 0, metadata !2883, null}
!2888 = metadata !{i32 138, i32 2, metadata !2883, null}
!2889 = metadata !{i32 139, i32 22, metadata !2883, null}
!2890 = metadata !{i32 786688, metadata !2883, metadata !"setCount", metadata !870, i32 139, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2891 = metadata !{i32 140, i32 31, metadata !2883, null}
!2892 = metadata !{i32 786688, metadata !2883, metadata !"centroidDataCount", metadata !870, i32 140, metadata !873, i32 0, i32 0} ; [ DW_TAG_auto_variable ]
!2893 = metadata !{i32 142, i32 2, metadata !2883, null}
