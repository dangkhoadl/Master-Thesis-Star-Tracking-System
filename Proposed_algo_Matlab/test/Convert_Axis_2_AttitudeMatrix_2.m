function C= Convert_Axis_2_AttitudeMatrix_2(RA,DEC,angle)
...
c1z=0;
c1= [c1x c1y c1z];
% The y axis of camera c2 = cross(c3,c1)
c2x= (c3(1)*c3(3)) / sqrt((c3(1)^2)+(c3(2)^2));
c2y = (c3(2)*c3(3)) / sqrt((c3(1)^2)+(c3(2)^2));
c2z = -(c3(1)^2 + c3(2)^2) / sqrt((c3(1)^2)+(c3(2)^2));
c2 = [c2x c2y c2z];
