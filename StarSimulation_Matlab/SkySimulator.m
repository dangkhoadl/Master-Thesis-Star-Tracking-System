...
for RA = 1 :1: 360 
    for DEC = -89:1:89
        ...
        cd('D:\Dropbox\DangKhoa\CEE_Cache\StarTracker\StarSimulation_Matlab');
        ...
        baseFileName = sprintf('D:\\Dropbox\\DangKhoa\\CEE_Cache\\StarTracker\\StarSimulation_Matlab\\TestPattern\\IMG_%d_%d.txt',RA,DEC);
